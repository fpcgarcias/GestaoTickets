...
- [-] 2. Endpoints backend — Tendência e Heatmap
  - [-] 2.1 Implementar `GET /api/tickets/dashboard-trend` em `server/routes/dashboard.ts`
  ...
  - [ ] 2.3 Implementar `GET /api/tickets/dashboard-heatmap` em `server/routes/dashboard.ts`
...
- [ ] 3. Endpoints backend — Ranking, SLA e Backlog
  - [ ] 3.1 Implementar `GET /api/tickets/dashboard-ranking` em `server/routes/dashboard.ts`
  ...
  - [ ] 3.3 Implementar `GET /api/tickets/dashboard-sla` em `server/routes/dashboard.ts`
    - Aceitar query params: `start_date`, `end_date`, filtros existentes
  ...
  - [ ] 3.5 Implementar `GET /api/tickets/dashboard-backlog` em `server/routes/dashboard.ts`
...
- [ ] 4. Endpoint backend — Drill-down
  - [ ] 4.1 Implementar `GET /api/tickets/dashboard-drilldown` em `server/routes/dashboard.ts`
...
- [ ] 5. Checkpoint — Validar endpoints backend
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 6. Componentes frontend — Gráficos de Tendência e Heatmap
  - [ ] 6.1 Criar componente `TrendChart` em `client/src/components/charts/trend-chart.tsx`
  ...
  - [ ] 6.2 Criar componente `HeatmapChart` em `client/src/components/charts/heatmap-chart.tsx`
...
- [ ] 7. Componentes frontend — Ranking, SLA e Funil
  - [ ] 7.1 Criar componente `AgentRankingTable` em `client/src/components/charts/agent-ranking-table.tsx`
  ...
  - [ ] 7.2 Criar componente `SlaComplianceCard` em `client/src/components/charts/sla-compliance-card.tsx`
  ...
  - [ ] 7.3 Criar componente `FunnelChart` em `client/src/components/charts/funnel-chart.tsx`
...
- [ ] 8. Componentes frontend — Backlog, Comparativo e Agregação
  - [ ] 8.1 Criar componente `BacklogMetricsCards` em `client/src/components/charts/backlog-metrics-cards.tsx`
  ...
  - [ ] 8.2 Criar componente `PeriodComparison` em `client/src/components/charts/period-comparison.tsx`
  ...
  - [ ] 8.4 Criar componente `AggregationSelector` em `client/src/components/charts/aggregation-selector.tsx`
...
- [ ] 9. Componentes frontend — Drill-down e Exportação
  - [ ] 9.1 Criar componente `DrillDownModal` em `client/src/components/charts/drill-down-modal.tsx`
  ...
  - [ ] 9.2 Criar componente `ExportButton` em `client/src/components/charts/export-button.tsx`
...
- [ ] 10. Checkpoint — Validar componentes frontend isolados
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 11. Integração no Dashboard
  - [ ] 11.1 Adicionar queries TanStack Query no `dashboard.tsx` para os novos endpoints
  ...
  - [ ] 11.2 Integrar novos componentes no layout do `dashboard.tsx`
  ...
  - [ ] 11.3 Integrar DrillDownModal com todos os gráficos clicáveis
...
- [ ] 12. Internacionalização
  - [ ] 12.1 Adicionar todas as chaves i18n em `client/src/i18n/messages/pt-BR.json` e `client/src/i18n/messages/en-US.json`
...
- [ ] 13. Controle de acesso e super_admin
  - [ ] 13.1 Implementar verificações de role no frontend para todos os novos componentes
  ...
  - [ ] 13.2 Validar permissões de acesso no backend em todos os novos endpoints
