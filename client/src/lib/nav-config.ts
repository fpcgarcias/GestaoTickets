...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/clients", icon: Users, labelKey: 'sidebar.clients', roles: ['admin', 'support', 'company_admin', 'manager', 'supervisor'] },
  { href: "/users", icon: Users, labelKey: 'sidebar.users', roles: ['admin', 'company_admin', 'manager', 'supervisor'] },
  { href: "/officials", icon: UserCog, labelKey: 'sidebar.officials', roles: ['admin', 'company_admin', 'manager', 'supervisor', 'support'] },
